...
const filteredPosts: Post[] = posts.filter(
          (post) => ["Page"].includes(post.postType)
        );
          ...
          filteredPosts.map((post) => (
            <li key={post._id}>
              ...
              >
                ...
                {/* Read more */}
                <p className="mt-4 text-xs font-mono text-sky-500/70 group-hover:text-sky-400 transition-colors duration-200 flex items-center gap-1.5">
                  Read more
